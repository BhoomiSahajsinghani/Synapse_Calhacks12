...
export const flowNode = pgTable('FlowNode', {
  id: varchar('id', { length: 255 }).primaryKey().notNull(),
  chatId: uuid('chatId')
    .notNull()
    .references(() => chat.id, { onDelete: 'cascade' }),
  type: varchar('type', { length: 50 }).notNull(), // 'conversationNode', 'promptNode'
  positionX: varchar('positionX', { length: 50 }).notNull(),
...
export type FlowNode = InferSelectModel<typeof flowNode>;

export const flowEdge = pgTable('FlowEdge', {
  id: varchar('id', { length: 255 }).primaryKey().notNull(),
  chatId: uuid('chatId')
    .notNull()
    .references(() => chat.id, { onDelete: 'cascade' }),
...
export type FlowEdge = InferSelectModel<typeof flowEdge>;
